    ...
    <div class="">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ route('form-nasabah.store', ['id' => $user['id']]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" name="nama_lengkap" placeholder="Masukkan Nama Lengkap" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" id="nomor_telepon_jaminan" name="nomor_telepon_jaminan" placeholder="Masukkan Nomor Telepon Jaminan" />
                                </div>

                                <div class="form-group">
                                    <label for="tempat_tgl_lahir">Tempat, Tanggal Lahir</label>
                                    <input type="tel" class="form-control" id="tempat_tgl_lahir" name="tempat_tgl_lahir" placeholder="Kota/Tanggal/Bulan/Tahun" />
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" placeholder="Masukkan Nama Orangtua" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            aria-label="Username" aria-describedby="basic-addon1" name="email" value="{{$user['email']}}"  readonly />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" name="no_rekening" placeholder="Masukkan Nomor Rekening" />
                                </div>
